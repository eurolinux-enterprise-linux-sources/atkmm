...
NoOpObject::NoOpObject(NoOpObject&& src) noexcept
: Atk::Object(std::move(src))
  , Component(std::move(src))
  , Action(std::move(src))
  , EditableText(std::move(src))
  , Image(std::move(src))
  , Selection(std::move(src))
  , Table(std::move(src))
  , Text(std::move(src))
  , Hypertext(std::move(src))
  , Value(std::move(src))
{}

NoOpObject& NoOpObject::operator=(NoOpObject&& src) noexcept
{
  Atk::Object::operator=(std::move(src));
  Component::operator=(std::move(src));
  Action::operator=(std::move(src));
  EditableText::operator=(std::move(src));
  Image::operator=(std::move(src));
  Selection::operator=(std::move(src));
  Table::operator=(std::move(src));
  Text::operator=(std::move(src));
  Hypertext::operator=(std::move(src));
  Value::operator=(std::move(src));
  return *this;
}

NoOpObject::~NoOpObject() noexcept
{}
