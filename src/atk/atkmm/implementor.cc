...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    AtkObject* retval = (*base->ref_accessible)(self);
    return retval;
  }
...
Implementor::Implementor(const Glib::Interface_Class& interface_class)
: Glib::Interface(interface_class)
{
}

Implementor::Implementor(Implementor&& src) noexcept
: Glib::Interface(std::move(src))
{}

Implementor& Implementor::operator=(Implementor&& src) noexcept
{
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->ref_accessible)
  {
    Glib::RefPtr<Object> retval(Glib::wrap((*base->ref_accessible)(gobj()), true));
    return retval;
  }
