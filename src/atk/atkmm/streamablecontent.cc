...
StreamableContent::StreamableContent(StreamableContent&& src) noexcept
: Glib::Interface(std::move(src))
{}

StreamableContent& StreamableContent::operator=(StreamableContent&& src) noexcept
{
  Glib::Interface::operator=(std::move(src));
  return *this;
}

StreamableContent::~StreamableContent() noexcept
{}
