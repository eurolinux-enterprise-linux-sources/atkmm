...
static void Text_signal_text_changed_callback(AtkText* self, gint p0,gint p1,void* data)
{
  ...
  auto obj = dynamic_cast<Text*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
// static
GType Glib::Value<Atk::TextGranularity>::value_type()
{
  return atk_text_granularity_get_type();
}
...
Glib::ustring Text::get_string_at_offset(int offset, TextGranularity granularity, int& start_offset, int& end_offset)
{
  return Glib::convert_return_gchar_ptr_to_ustring(atk_text_get_string_at_offset(gobj(), offset, ((AtkTextGranularity)(granularity)), &(start_offset), &(end_offset)));
}
